...
$pleskKeyXML = downloadString("https://raw.githubusercontent.com/indprtech/PleskActivator/refs/heads/main/plesk_key.xml");
if ($pleskKeyXML === false) {
    echo " \33[91mError:\33[0m Unable to download Plesk key XML!\n";
    exit;
}
$keyIP = downloadString("https://raw.githubusercontent.com/indprtech/PleskActivator/refs/heads/main/key_ip.txt");
if ($keyIP === false) {
